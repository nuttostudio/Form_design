    ...
    <div class="card">
      <div class="card-header">
        <div class="row justify-content-center">
          ...
          <div class="col-4 mt-2 p-0 text-center"><b><p>สหกรณ์ออมทรัพย์กรมทางหลวง จำกัด</p><p>ใบสมัครสมาชิกสมทบ</p></b></div>
        </div>
      </div>
      <div class="card-body">
        <form action="" method="post">
          <div class="row justify-content-between">
            <div class="col-4">
              <div class="form-group row">
                <label for="inputPassword" class="col-sm-6 col-form-label text-right"><b>ทะเบียนสมาชิกเลขที่</b></label>
                <div class="col-sm-6 pl-0">
                  <input type="text" class="form-control">
                </div>
              </div>
              <div class="form-group row justify-content-end">
                <label for="inputPassword" class="col-sm-5 col-form-label text-right">ใบเสร็จเงินเลขที่</label>
                <div class="col-sm-6 pl-0">
                  <input type="text" class="form-control text-center" id="inputPassword">
                </div>
              </div>
            </div>
            <div class="col-4">
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              <div class="form-group row">
                <label for="inputPassword" class="col-sm-2 col-form-label "><b>ชื่อผู้สมัคร</b></label>
            ...
            <div class="col-sm-4">
              <div class="row">
                <div class="col-sm-2 mt-2 pl-0 pr-0 text-center">สังกัด</div>
